export default async function handler(req,res){
  ...
  try{
    const r=await fetch('https://www.glo.or.th/api/lottery/getLatestLottery',{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json','User-Agent':'ChanJaSueHuayThukNguat/1.4.1'},body:'{}',signal:AbortSignal.timeout(8000)});
